<script>
import Basic from '@/components/op-doc/components-solts-docs/FancyButton.vue';
import BasicMoreContent from '@/components/op-doc/components-solts-docs/AwesomeIcon.vue';
import DefaultSlot from '@/components/op-doc/components-solts-docs/SubmitButton.vue';
import BaseLayout from '@/components/op-doc/components-solts-docs/BaseLayout.vue';
import DynamicSlotName from '@/components/op-doc/components-solts-docs/DynamicSlotName.vue';
import MyComponent from '@/components/op-doc/components-solts-docs/MyComponent.vue';
import NameScopeSlot from '@/components/op-doc/components-solts-docs/NameScopeSlot.vue';
import FancyList from '@/components/op-doc/components-solts-docs/FancyList.vue'
import MouseTracker from '@/components/op-doc/components-solts-docs/MouseTracker.vue';
export default {
    components: { Basic, BasicMoreContent, DefaultSlot, BaseLayout, DynamicSlotName, MyComponent, NameScopeSlot, FancyList, MouseTracker },
    data() {
        return {
