<script setup>
import { ref } from 'vue';
import PropBasic from '@/components/com-doc/components-props-docs/declare-basic-use.vue';
import PropBasic2 from '@/components/com-doc/components-props-docs/declare-basic-use2.vue';
import { Person } from '@/components/com-doc/components-props-docs/Person';
const fooValue = ref("declare 1");
const person = ref(new Person('John', 'Doe'));
